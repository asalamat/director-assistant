...
export class TransformersEmbeddingService extends BaseEmbeddingService {
  ...
  constructor(config: TransformersEmbeddingConfig) {
    ...
    if (!xenovaDeprecationWarned && process.env.CLAUDE_FLOW_SUPPRESS_DEPRECATION !== '1') {
      ...
      process.emitWarning(
        "@claude-flow/embeddings: 'transformers' provider is deprecated " +
        ...
        { type: 'DeprecationWarning', code: 'CLAUDE_FLOW_EMBEDDINGS_XENOVA_DEPRECATED' },
      );
    }
  }
...
export function createEmbeddingService(config: EmbeddingConfig): IEmbeddingService {
  switch (config.provider) {
    ...
    case 'ruvector-onnx':
      ...
      return new RuvectorOnnxEmbeddingService(config as RuvectorOnnxEmbeddingConfig);
    default:
      throw new Error(
