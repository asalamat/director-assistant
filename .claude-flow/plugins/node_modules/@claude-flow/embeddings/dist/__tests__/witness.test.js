...
import { witness, verify, canonicalHash, corpusFingerprint, generateEphemeralKeypair, } from '../witness.js';
...
describe('canonicalHash — determinism', () => {
    ...
    it('handles nested structures', () => {
        expect(canonicalHash({ a: { b: { c: [1, 2] } } })).toBe(canonicalHash({ a: { b: { c: [1, 2] } } }));
    });
...
describe('corpusFingerprint', () => {
    ...
    it('is sensitive to content changes', () => {
        expect(corpusFingerprint([{ id: 'a', content: 'foo' }])).not.toBe(corpusFingerprint([{ id: 'a', content: 'bar' }]));
    });
