...
import { recallAtK, precisionAtK, reciprocalRank, meanReciprocalRank, dcgAtK, idcgAtK, ndcgAtK, compareRankings, } from '../ir-metrics.js';
describe('recallAtK', () => {
...
describe('compareRankings', () => {
    it('computes recall/precision/ndcg at all requested k values + MRR in one pass', () => {
        ...
        const cmp = compareRankings(['a', 'b', 'x', 'y', 'c'], new Set(['a', 'b', 'c']), [1, 3, 5]);
    ...
    it('accepts graded judgements (Map)', () => {
        const cmp = compareRankings(['a', 'b', 'c'], new Map([['a', 3], ['b', 2], ['c', 1]]), [3]);
    ...
    it('returns 0 for all metrics on empty judgements', () => {
        const cmp = compareRankings(['a', 'b'], new Set(), [1, 2]);
...
//# sourceMappingURL=ir-metrics.test.js.map