...
import { getMetricAtPath, entriesForBenchmark, pickBaseline, checkRegression, checkRegressionBatch, } from '../ledger-analyzer.js';
import { appendToLedger, generateLedgerKeypair } from '../witness-ledger.js';
function input(name, ts, results, opts = {}) {
    return {
        benchmark: name,
        timestamp: ts,
