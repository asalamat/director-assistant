...
import { extractRetrievalFeatures, adaptiveRoute, } from '../adaptive-router.js';
const DIM = 8;
function vec(values) {
...
describe('extractRetrievalFeatures — Phase 17 bm25 input', () => {
    it('high-IDF query → high rareTokenDensity', () => {
        ...
        const f = extractRetrievalFeatures(null, vec([1]), [vec([1])], [vec([1])], { queryText: 'cveidentifier', index: fakeIndex });
    ...
    it('common-only query → low rareTokenDensity', () => {
        ...
        const f = extractRetrievalFeatures(null, vec([1]), [vec([1])], [vec([1])], { queryText: 'common', index: fakeIndex });
...
//# sourceMappingURL=adaptive-router.test.js.map