...
describe('averageEmbeddings — basic contract', () => {
    ...
    it('throws on weights length mismatch', () => {
        expect(() => averageEmbeddings([new Float32Array([1, 0]), new Float32Array([0, 1])], { weights: [1] })).toThrow(/weights\.length/);
    });
    it('throws on negative weights', () => {
        expect(() => averageEmbeddings([new Float32Array([1, 0])], { weights: [-1] })).toThrow(/negative/);
    });
});
...
//# sourceMappingURL=embedding-fusion.test.js.map