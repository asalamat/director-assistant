...
import { appendToLedger, verifyEntry, verifyLedger, generateLedgerKeypair, } from '../witness-ledger.js';
function input(name, ts, results) {
    return {
        benchmark: name,
        timestamp: ts,
        commit: `commit-${name}`,
...
describe('verifyLedger — happy path', () => {
    ...
    it('unknown version rejected', () => {
        const result = verifyLedger({ version: 99 });
...
//# sourceMappingURL=witness-ledger.test.js.map