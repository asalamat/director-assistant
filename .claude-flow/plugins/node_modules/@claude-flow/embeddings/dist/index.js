...
export { createEmbeddingService, createEmbeddingServiceAsync, getEmbedding, cosineSimilarity, euclideanDistance, dotProduct, computeSimilarity, OpenAIEmbeddingService, TransformersEmbeddingService, MockEmbeddingService, AgenticFlowEmbeddingService, BaseEmbeddingService, } from './embedding-service.js';
// ADR-121 Phase 1 — WASM+SIMD ONNX provider via ruvector-onnx-embeddings-wasm.
export { RuvectorOnnxEmbeddingService, createRuvectorOnnxEmbeddingService, } from './ruvector-onnx-embedding-service.js';
...
export { SearchableEmbeddingCache, createSearchableEmbeddingCache, } from './searchable-embedding-cache.js';
...
export { probeRuvectorSidecar, formatRuvectorAvailability, } from './ruvector-mcp-probe.js';
...
export { int8Encode, int8Decode, measureInt8RoundTripRecall, RabitqSnapshot, rabitqMemoryReduction, } from './quantization.js';
...
export { DiskannSnapshot, diskannAvailable, } from './diskann-snapshot.js';
...
export { AnnRouter, decideBacking, } from './ann-router.js';
...
export { mmrRerank, mmrIds, averagePairwiseSimilarity, } from './mmr.js';
...
// for ensemble RAG.
export { reciprocalRankFusion, rrfIds, } from './rrf.js';
...
export { averageEmbeddings, isUnitNorm, } from './embedding-fusion.js';
...
export { tokenize, buildBm25Index, bm25Score, bm25TopK, idfOf, queryMeanIdf, } from './bm25.js';
...
export { EmbedCache, wrapWithCache, canonicalizeText, } from './embed-cache.js';
...
// signals fire early.
export { lazyAdaptiveRoute, } from './lazy-adaptive-router.js';
...
export { extractRetrievalFeatures, adaptiveRoute, } from './adaptive-router.js';
...
export { compoundRetrieval, } from './compound-retrieval.js';
...
// CI/PR dashboards.
export { renderSparkline, detectDrift, summarizeBenchmarkTrend, } from './ledger-trends.js';
...
export { getMetricAtPath, entriesForBenchmark, pickBaseline, checkRegression, checkRegressionBatch, } from './ledger-analyzer.js';
...
export { appendToLedger, verifyEntry, verifyLedger, generateLedgerKeypair, coSign, verifyCosignatureAgainst, } from './witness-ledger.js';
...
export { witness, verify, canonicalHash, corpusFingerprint, generateEphemeralKeypair, } from './witness.js';
...
export { buildSyntheticTopicCorpus, } from './synthetic-corpus.js';
...
export { recallAtK, precisionAtK, reciprocalRank, meanReciprocalRank, dcgAtK, idcgAtK, ndcgAtK, meanMetric, compareRankings, } from './ir-metrics.js';
...
export { RvfEmbeddingCache, } from './rvf-embedding-cache.js';
// Chunking utilities
...
export { projectToPoincareBall as projectToPoincareBallAsync, poincareDistance as poincareDistanceAsync, expMap as expMapAsync, logMap as logMapAsync, mobiusAddition as mobiusAdditionAsync, hyperbolicAttentionAvailable, } from './hyperbolic-attention.js';
// Persistent cache
