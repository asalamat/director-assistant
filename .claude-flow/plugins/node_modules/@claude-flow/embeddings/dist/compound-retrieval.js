 ...
 */
export async function compoundRetrieval(intents, search, options) {
    ...
    const intentQueries = intents.map(intent => averageEmbeddings(intent.hypotheticalVectors, {
        normalizeInputs: true,
        normalizeOutput: true,
    }));
    // Stage 2 — search per intent, then MMR-rerank each candidate list.
    const intentHitLists = [];
    const traces = [];
...
//# sourceMappingURL=compound-retrieval.js.map