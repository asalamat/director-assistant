 ...
 */
export function mmrRerank(candidates, queryVector, options) {
 ...
 */
export function mmrIds(candidates, queryVector, options) {
 ...
 */
export function averagePairwiseSimilarity(picked) {
    if (picked.length < 2)
        return 0;
    let total = 0;
    let pairs = 0;
